  ...
  const hotels = await Promise.all([
    prisma.business.create({
      data: {
        ...
        isEcoCertified: true,
        ecoStatus: "APPROVED",
        coverPhotoUrl: "https://picsum.photos/seed/hue-hotel/400/300",
    ...
    prisma.business.create({
      data: {
        ...
        coverPhotoUrl: "https://picsum.photos/seed/ivywall-hotel/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        isEcoCertified: true,
        ecoStatus: "APPROVED",
        coverPhotoUrl: "https://picsum.photos/seed/aziza-hotel/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7415,
        phone: "(048) 723-9888",
        coverPhotoUrl: "https://picsum.photos/seed/hotel-centro/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7365,
        phone: "(048) 434-8888",
        coverPhotoUrl: "https://picsum.photos/seed/canvas-boutique/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7390,
        lng: 118.7340,
        coverPhotoUrl: "https://picsum.photos/seed/go-hotels-pp/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7430,
        phone: "(048) 434-3333",
        coverPhotoUrl: "https://picsum.photos/seed/citystate-asturias/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7460,
        lng: 118.7355,
        coverPhotoUrl: "https://picsum.photos/seed/palawan-uno/400/300",
        circuitId: cityCore.id,
      },
    }),
  ]);
  ...
  const resorts = await Promise.all([
    prisma.business.create({
      data: {
        ...
        isEcoCertified: true,
        ecoStatus: "APPROVED",
        coverPhotoUrl: "https://picsum.photos/seed/astoria-resort/400/300",
    ...
    prisma.business.create({
      data: {
        ...
        lng: 118.7900,
        phone: "(048) 434-2500",
        coverPhotoUrl: "https://picsum.photos/seed/costa-palawan/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        coverPhotoUrl: "https://picsum.photos/seed/princesa-garden/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7345,
        phone: "(048) 434-6868",
        coverPhotoUrl: "https://picsum.photos/seed/microtel-pp/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        isEcoCertified: true,
        ecoStatus: "APPROVED",
        coverPhotoUrl: "https://picsum.photos/seed/daluyon-resort/400/300",
  ...
  const restaurants = await Promise.all([
    prisma.business.create({
      data: {
        ...
        isEcoCertified: true,
        ecoStatus: "APPROVED",
        coverPhotoUrl: "https://picsum.photos/seed/badjao-seafood/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7375,
        phone: "(048) 433-2580",
        coverPhotoUrl: "https://picsum.photos/seed/kalui-resto/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7468,
        lng: 118.7360,
        coverPhotoUrl: "https://picsum.photos/seed/bakers-kitchen/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7400,
        lng: 118.7355,
        coverPhotoUrl: "https://picsum.photos/seed/la-terrasse/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7530,
        lng: 118.7440,
        coverPhotoUrl: "https://picsum.photos/seed/bernardos-resto/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7472,
        lng: 118.7362,
        coverPhotoUrl: "https://picsum.photos/seed/happy-husky/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7500,
        ecoStatus: "PENDING",
        coverPhotoUrl: "https://picsum.photos/seed/cacaoyan-forest/400/300",
    ...
    prisma.business.create({
      data: {
        ...
        lat: 9.7535,
        lng: 118.7445,
        coverPhotoUrl: "https://picsum.photos/seed/cafemoto-pp/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7462,
        lng: 118.7358,
        coverPhotoUrl: "https://picsum.photos/seed/divine-sweets/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7540,
        lng: 118.7450,
        coverPhotoUrl: "https://picsum.photos/seed/acacia-garden/400/300",
        circuitId: cityCore.id,
      },
    }),
  ]);
  ...
  const artisans = await Promise.all([
    prisma.business.create({
      data: {
        ...
        lat: 9.7478,
        lng: 118.7368,
        coverPhotoUrl: "https://picsum.photos/seed/kaingud-arts/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7474,
        lng: 118.7372,
        coverPhotoUrl: "https://picsum.photos/seed/amaza-pearls/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7510,
        lng: 118.7420,
        coverPhotoUrl: "https://picsum.photos/seed/palawan-treasures/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lng: 118.7280,
        ecoStatus: "PENDING",
        coverPhotoUrl: "https://picsum.photos/seed/magayen-viewdeck/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7385,
        lng: 118.7338,
        coverPhotoUrl: "https://picsum.photos/seed/ww2-memorial/400/300",
        circuitId: cityCore.id,
      },
    }),
  ]);
  ...
  const travelTours = await Promise.all([
    prisma.business.create({
      data: {
        ...
        lng: 118.7363,
        phone: "(048) 434-1234",
        coverPhotoUrl: "https://picsum.photos/seed/7wonders-tours/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.8200,
        lng: 118.7600,
        coverPhotoUrl: "https://picsum.photos/seed/dolphin-whale-tours/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7471,
        lng: 118.7367,
        coverPhotoUrl: "https://picsum.photos/seed/el-taraw-tours/400/300",
        circuitId: cityCore.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7525,
        lng: 118.7435,
        coverPhotoUrl: "https://picsum.photos/seed/bearcat-nature/400/300",
        circuitId: ecoAdventure.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7392,
        lng: 118.7342,
        coverPhotoUrl: "https://picsum.photos/seed/halika-tours/400/300",
        circuitId: cityCore.id,
      },
    }),
  ]);
  ...
  const tourDestinations = await Promise.all([
    prisma.business.create({
      data: {
        ...
        lat: 10.1800,
        lng: 118.8950,
        coverPhotoUrl: "https://picsum.photos/seed/sabang-falls/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.1850,
        lng: 118.8980,
        coverPhotoUrl: "https://picsum.photos/seed/sabang-ferry/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.1830,
        lng: 118.8940,
        coverPhotoUrl: "https://picsum.photos/seed/sabang-mangrove/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.1840,
        lng: 118.8920,
        coverPhotoUrl: "https://picsum.photos/seed/sabang-jungle/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.1500,
        lng: 118.8700,
        coverPhotoUrl: "https://picsum.photos/seed/ugong-rock/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.1480,
        lng: 118.8680,
        coverPhotoUrl: "https://picsum.photos/seed/hundred-caves/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.1550,
        lng: 118.8650,
        coverPhotoUrl: "https://picsum.photos/seed/buenavista-view/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.0800,
        lng: 118.8200,
        coverPhotoUrl: "https://picsum.photos/seed/batak-center/400/300",
    ...
    prisma.business.create({
      data: {
        ...
        lat: 10.1520,
        lng: 118.8720,
        coverPhotoUrl: "https://picsum.photos/seed/taraw-cave/400/300",
        circuitId: undergroundRiver.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.8500,
        lng: 118.7800,
        coverPhotoUrl: "https://picsum.photos/seed/babuyan-sandbar/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 10.0500,
        lng: 118.8100,
        coverPhotoUrl: "https://picsum.photos/seed/bacungan-mangrove/400/300",
    ...
    prisma.business.create({
      data: {
        ...
        lat: 9.8600,
        lng: 118.7900,
        coverPhotoUrl: "https://picsum.photos/seed/hobbai-island/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7620,
        lng: 118.7250,
        coverPhotoUrl: "https://picsum.photos/seed/canigaran-cottage/400/300",
        circuitId: bayCoastal.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.6800,
        lng: 118.7100,
        coverPhotoUrl: "https://picsum.photos/seed/simpokan-trail/400/300",
        circuitId: southernCultural.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.6790,
        lng: 118.7080,
        coverPhotoUrl: "https://picsum.photos/seed/simpokan-marine/400/300",
        circuitId: southernCultural.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.6500,
        lng: 118.6900,
        coverPhotoUrl: "https://picsum.photos/seed/tagkuriring-falls/400/300",
        circuitId: southernCultural.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.6400,
        lng: 118.6800,
        coverPhotoUrl: "https://picsum.photos/seed/tagkawayan-beach/400/300",
        circuitId: southernCultural.id,
      },
    }),
    prisma.business.create({
      data: {
        ...
        lat: 9.7550,
        lng: 118.7460,
        coverPhotoUrl: "https://picsum.photos/seed/acacia-tunnel/400/300",
        circuitId: cityCore.id,
      },
    }),
  ]);
